...
for protein in pdb_listem:
    ...
    os.chdir(input_path)
    with open(f"{current_path}/outputs/Megadock_OUT/{protein}_translate/ligand_filtration_translated.json",
              'r') as f:
    ...
    energy_filtered_list, energy_dic = ranking_of_cluster_faster.energy_filtering_new(protein, sasa_filtered_list,
                                                                                      input_path)
    ...
    pizsa_filtered_list, pizsa_dic = ranking_of_cluster_faster.pizsa_filtering_with_threshold(energy_filtered_list,
                                                                                              input_path, 1)
    ...
    os.chdir(input_path)
    vorquma_filtered_list, vorquma_dic = ranking_of_cluster_faster.vormqa_filtering(stability_filtered,
                                                                                    input_path,
                                                                                    0.0)  # 0
    ...
    print("PIZSA stability number:",len(stability_filtered))
